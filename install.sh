...
| Speed violation | Both lights → RED for 10 s |
...
```
  ...
  Road-2 YEL  / GPIO19  (35)(36) GPIO 16
  Road-2 GRN  / GPIO26  (37)(38) GPIO 20
...
Road 1 GREEN
     ...
     │
     └─ ToF speed > limit       → BOTH RED for 10 s (emergency)
          │
...
| `SPEED_LIMIT_KMPH` | `40` | Speed violation threshold (both RED) |
